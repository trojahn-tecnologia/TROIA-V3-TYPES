...
export const TAG_ENTITY_COLLECTIONS: Readonly<Record<TagEntityKind, string>> = Object.freeze({
  contact: 'contacts',
  ticket: 'tickets',
  customer: 'customers',
 ...
 */
export const TAG_COLOR_PALETTE: readonly string[] = Object.freeze([
  '#7E22CE', // purple-700
  '#1D4ED8', // blue-700
  '#15803D', // green-700
  '#A16207', // yellow-700
...
export const pickTagColor = (name: string): string => {
  ...
  return TAG_COLOR_PALETTE[index] as string;
};

/** `true` para `#RRGGBB`. O Zod do backend usa a mesma regra. */
export const isValidTagColor = (value: string): boolean => /^#[0-9a-fA-F]{6}$/.test(value);
