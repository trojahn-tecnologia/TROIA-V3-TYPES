...
// ============================================================================
// CHANNEL SATISFACTION (CSAT) CONFIG
// ============================================================================
 ...
 */
export const DEFAULT_CHANNEL_SATISFACTION_CONFIG: ChannelSatisfactionConfig = {
  enabled: false,
