 ...
 */
export function isPausedCategory(category: TicketStatusCategory): boolean {
  return TICKET_STATUS_CATEGORIES[category]?.slaBehavior === 'paused';
}

// ============================================================================
// ALERTA DE ETAPA (estagnação) — HORAS, não dias
// ============================================================================
...
export const SYSTEM_TICKET_ALERT_DEFAULTS: {
  timeInStage: TicketAlertClockConfig;
} = {
