...
import type { TicketPipeline, TicketStage } from './ticket-pipelines';
 ...
 * >;
 */
export type ToModel<T, ObjIdFields extends keyof T = never, DateFields extends keyof T = never> = Omit<T, 'id' | ObjIdFields | DateFields> & {
    _id?: ObjectId;
    deletedAt?: Date;
} & {
    [K in ObjIdFields]: T[K] extends string ? ObjectId : T[K] extends string | undefined ? ObjectId | undefined : T[K];
} & {
    [K in DateFields]: T[K] extends string ? Date : T[K] extends string | undefined ? Date | undefined : T[K];
};
/**
 ...
 */
export type ToModelFromResponse<TResponse, ObjIdFields extends keyof TResponse = never, DateFields extends keyof TResponse = never> = ToModel<TResponse, ObjIdFields, DateFields>;
/** App - Documento da aplicação (sem companyId) */
export type AppModel = ToModel<App, never, 'createdAt' | 'updatedAt'>;
/** Company - Documento da empresa */
export type CompanyModel = ToModel<Company, 'appId', 'createdAt' | 'updatedAt'>;
/** User - Documento do usuário */
export type UserModel = ToModel<User, 'appId' | 'companyId' | 'levelId', 'createdAt' | 'updatedAt' | 'lastLoginAt'>;
/** Team - Equipe */
export type TeamModel = ToModel<Team, 'appId' | 'companyId', 'createdAt' | 'updatedAt'>;
/** TeamUser - Membro de equipe */
export type TeamUserModel = ToModel<TeamUser, 'appId' | 'companyId' | 'teamId' | 'userId', 'joinedAt'>;
/** TeamResource - Recurso de equipe */
export type TeamResourceModel = ToModel<TeamResource, 'appId' | 'companyId' | 'teamId' | 'resourceId' | 'assignedBy', 'assignedAt'>;
/** Channel - Canal de comunicação */
export type ChannelModel = ToModel<Channel, 'appId' | 'companyId', 'createdAt' | 'updatedAt'>;
/**
 ...
 */
export type ShiftModel = Shift & {
    deletedAt?: Date;
};
/** Level - Nível hierárquico */
export type LevelModel = ToModel<Level, 'appId' | 'companyId', 'createdAt' | 'updatedAt'>;
/** Plan - Plano */
export type PlanModel = ToModel<Plan, 'appId', 'createdAt' | 'updatedAt'>;
/** Contact - Contato */
export type ContactModel = ToModel<Contact, 'appId' | 'companyId' | 'customerId' | 'assigneeId' | 'teamId', 'createdAt' | 'updatedAt'>;
/** Customer - Cliente */
export type CustomerModel = ToModel<Customer, 'appId' | 'companyId' | 'assigneeId' | 'teamId', 'createdAt' | 'updatedAt'>;
/** Lead - Oportunidade */
export type LeadModel = ToModel<Lead, 'appId' | 'companyId' | 'contactId' | 'channelId' | 'funnelId' | 'stepId' | 'assigneeId' | 'teamId' | 'assignedBy' | 'customerId', 'createdAt' | 'updatedAt' | 'assignedAt' | 'lostDate' | 'lastInteractionAt' | 'lastFollowUpAt' | 'lastStepAt' | 'lastActivityAt' | 'wonDate'>;
/**
...
export type TicketModel = ToModel<Ticket, 'appId' | 'companyId' | 'pipelineId' | 'stageId' | 'customerId' | 'contactId' | 'leadId' | 'assigneeId' | 'teamId' | 'assignedBy' | 'conversationId' | 'channelId', 'createdAt' | 'updatedAt' | 'assignedAt' | 'firstResponseAt' | 'lastResponseAt' | 'resolvedAt' | 'closedAt' | 'dueDate'>;
/**
 ...
 */
export type ConversationMessageModel = ToModel<ConversationMessage, 'appId' | 'companyId' | 'conversationId', 'sentAt' | 'deliveredAt' | 'readAt' | 'createdAt' | 'updatedAt'>;
/** Activity - Registro de atividade */
export type ActivityModel = ToModel<Activity, 'appId' | 'companyId' | 'entityId' | 'actorId', 'occurredAt' | 'createdAt' | 'updatedAt'>;
/** AppIntegration - Integração a nível de app */
export type AppIntegrationModel = ToModel<AppIntegrationResponse, 'appId', 'createdAt' | 'updatedAt'>;
/** CompanyIntegration - Integração a nível de empresa */
export type CompanyIntegrationModel = ToModel<CompanyIntegrationResponse, 'appId' | 'companyId', 'createdAt' | 'updatedAt' | 'lastSyncAt'>;
/** ExternalApiKey - Chave de API */
export type ExternalApiKeyModel = ToModel<ExternalApiKeyResponse, 'appId' | 'companyId', 'createdAt' | 'updatedAt' | 'lastUsedAt' | 'expiresAt'>;
/** EmailTemplate - Template de email */
export type EmailTemplateModel = ToModel<EmailTemplateResponse, 'appId' | 'companyId', 'createdAt' | 'updatedAt'>;
 ...
 * }
 */
export declare const MODEL_OBJECTID_FIELDS: {
    readonly ticket: readonly ["appId", "companyId", "pipelineId", "stageId", "customerId", "contactId", "leadId", "assigneeId", "teamId", "assignedBy", "conversationId", "channelId"];
    readonly ticketPipeline: readonly ["appId", "companyId"];
    readonly ticketStage: readonly ["appId", "companyId", "pipelineId"];
    readonly conversation: readonly ["appId", "companyId", "channelId", "customerId", "contactId", "leadId", "ticketId", "assigneeId", "teamId", "assignedBy"];
    readonly conversationMessage: readonly ["appId", "companyId", "conversationId", "fromUserId", "toUserId"];
    readonly lead: readonly ["appId", "companyId", "contactId", "channelId", "funnelId", "stepId", "assigneeId", "teamId", "assignedBy", "customerId"];
    readonly contact: readonly ["appId", "companyId", "customerId", "assigneeId", "teamId"];
    readonly customer: readonly ["appId", "companyId", "assigneeId", "teamId"];
    readonly user: readonly ["appId", "companyId", "levelId"];
    readonly channel: readonly ["appId", "companyId"];
    readonly shift: readonly ["appId", "companyId", "userId", "teamId"];
    readonly savedCard: readonly ["appId", "companyId", "userId"];
};
