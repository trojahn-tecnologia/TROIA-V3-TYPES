...
export type AssignmentSource = 'manual' | 'auto' | 'creation';
/**
 ...
 */
export type AssignmentStrategy = 'manual' | 'sequential' | 'fixed_operator' | 'fixed_team' | 'shift' | 'availability' | 'last_interaction' | 'routing_rule' | 'ai_tool' | 'workflow'
