 ...
 */
export declare const DOCUMENT_MEDIA_TYPES: readonly ["video", "audio", "frame"];
 ...
 */
export type DatabaseDocumentTransferRejectionCode = 'not_found' | 'wrong_type' | 'inactive_target' | 'integration_target' | 'integration_linked' | 'same_database' | 'write_failed';
 ...
 */
export declare const DATABASE_DOCUMENT_TRANSFER_MAX_ITEMS = 50;
/**
 ...
 * `false` para ela.
 */
export declare function isDocumentIntegrationLinked(doc: DatabaseDocumentIntegrationLinkInput | null | undefined): boolean;
