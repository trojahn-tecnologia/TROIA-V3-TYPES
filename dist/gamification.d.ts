...
export type UpdateGamificationConfigRequest = Partial<Omit<GamificationConfig, 'id' | 'appId' | 'companyId' | 'createdAt' | 'updatedAt'>>;
export declare const DEFAULT_GAMIFICATION_RULES: GamificationRule[];
export declare const DEFAULT_GAMIFICATION_LEVELS: GamificationLevel[];
